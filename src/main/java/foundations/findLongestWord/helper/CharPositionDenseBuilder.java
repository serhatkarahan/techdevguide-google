...
public class CharPositionDenseBuilder {
    ...
    public Map<Character, List<Integer>> build(String givenStringS) {
        ...
        for (int indexOfS = 1; indexOfS < givenStringS.length(); indexOfS++) {
            ...
            updatePositionsMap(result, indexOfS, currentChar);
        }
    ...
    private void updatePositionsMap(Map<Character, List<Integer>> result, int indexOfS, char currentChar) {
